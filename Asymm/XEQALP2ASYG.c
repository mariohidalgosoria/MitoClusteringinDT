/*Computes ensemble average of the asymmetry versus the fusion exponent*/
#include<stdio.h>
#include<math.h>
#include<stdlib.h>
...
int main(void){
  ...
  for(id=ini;id<=Nexp;id++){          
    ...
    i=0;
    //Captura de datos:
    sprintf(nom,"XEQALP2ASYGT%d.dat",id);//coloca el id, xid.dat en una cadena 'nom'
  ...
  sprintf(nom,"EXEQALP2ASYG.dat");//la cadena nom='x_mean.dat'
